...
int main() {
	...
	if (num <= 0) {
		...
		while (i > 0) {
			...
			cout << "4.Remove required textbook from the website." << endl << "5.Print textbook with passed regex test." << endl << "6.EXIT." << endl << "You choose : " << endl;
			cin >> num;
